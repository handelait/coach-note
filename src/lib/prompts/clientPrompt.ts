...
- CHI TIẾT VÀ SÂU SẮC: Mỗi đề mục phải đào sâu vào bối cảnh (context) và cảm xúc của câu chuyện. MỖI ĐỀ MỤC PHẢI DÀI ÍT NHẤT 3-5 CÂU (chia làm các gạch đầu dòng con). Tuyệt đối không viết cụt lủn.
...
*(Ghi chú cho AI: PHẢI in chính xác và nguyên văn toàn bộ các câu hỏi dưới đây, tuyệt đối không tự chế hoặc customize câu hỏi theo transcript. Phần /tên Coachee/ hãy tự động điền tên thực tế của khách hàng)*
